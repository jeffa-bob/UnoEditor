...
namespace UnoEditor.Shared.Views
{
	...
	partial class Terminal2
	{
		...
		/// </remarks>
		public Terminal2(IntPtr javaReference, global::Android.Runtime.JniHandleOwnership transfer) : base (javaReference, transfer) { }
#endif
#if __IOS__ || __MACOS__
		/// <summary>
		/// Native constructor, do not use explicitly.
		...
		/// objects that may have been collected in the managed world.
		/// </remarks>
		public Terminal2(IntPtr handle) : base (handle) { }
#endif
	}
}
