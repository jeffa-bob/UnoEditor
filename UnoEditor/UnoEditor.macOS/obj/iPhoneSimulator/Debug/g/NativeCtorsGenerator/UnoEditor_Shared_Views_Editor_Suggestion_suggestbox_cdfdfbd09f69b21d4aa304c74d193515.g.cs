...
namespace UnoEditor.Shared.Views.Editor.Suggestion
{
	...
	partial class suggestbox
	{
		...
		/// </remarks>
		public suggestbox(IntPtr javaReference, global::Android.Runtime.JniHandleOwnership transfer) : base (javaReference, transfer) { }
#endif
#if __IOS__ || __MACOS__
		/// <summary>
		/// Native constructor, do not use explicitly.
		...
		/// objects that may have been collected in the managed world.
		/// </remarks>
		public suggestbox(IntPtr handle) : base (handle) { }
#endif
	}
}
